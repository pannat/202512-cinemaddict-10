...
const getMenu = () => `  <nav class="main-navigation">
...
const getMovieContainer = () => `<section class="films"></section>`;
...
const getCard = () => `<article class="film-card">
...
const getFullCard = () => `<section class="film-details">
...
const getUserRating = () => `<section class="header__profile profile">
